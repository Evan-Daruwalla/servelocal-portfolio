...
- `testing.md` — **277 tests** on SQLite *and* on real Postgres (`TEST_DATABASE_URL`), warnings-as-errors, migration up/down/up, browser/CDP verification reality. (2026-08-07)
