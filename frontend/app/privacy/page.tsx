      ...
      <div className="section" style={{ maxWidth: 760 }}>
        ...
        <div className="legal-body">
          ...
          <ul>
            ...
            <li><strong>Delete.</strong> Permanently delete your account from the <strong>Account</strong> section of your dashboard (password required). This removes your personal data and deactivates your account. <strong>Honest caveat:</strong> so that an organization&rsquo;s record of already-verified service survives, your applications and verified-hours history are <strong>kept in anonymized form with your name and identifying details removed</strong> &mdash; including any note, supervisor name, or appeal text attached to those hours &mdash; and entries in the append-only security audit log are retained for up to <strong>12 months</strong> from the date of the event. Messages you sent are handled the same way: the entry stays in the conversation so the other person&rsquo;s thread has no gaps, but the text you wrote is removed along with your name. Organizations must deactivate active listings before deleting.</li>
          </ul>
